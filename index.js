document.addEventListener("DOMContentLoaded", function () {
    const navButtons = [
        ...
        { id: "btn_cuenta_soporte", url: "pages/cuenta_soporte/cuenta_soporte.html" }
    ];
    ...
    function removeAllActiveStates() {
        const allActiveElements = document.querySelectorAll('.left-side .btn-active, .left-side .selected');
    ...
    navButtons.forEach(item => {
        ...
        if (item.id === "btn_inicio" && (normalizedPath.endsWith('/index.html') || normalizedPath.endsWith('/ecoalerta/') || normalizedPath.endsWith('/'))) {
            shouldBeActive = true;
        } else if (item.id === "btn_comunidad" && (normalizedPath.includes("/comunidad/") || normalizedPath.includes("detalle_campania.html"))) {
            shouldBeActive = true;
        } else if (item.id === "btn_cuenta_soporte" && (normalizedPath.includes("/cuenta_soporte/"))) {
            shouldBeActive = true;
